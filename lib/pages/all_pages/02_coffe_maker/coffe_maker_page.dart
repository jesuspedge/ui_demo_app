...
class _CoffeMakerPageState extends State<CoffeMakerPage>
  ...
  void didChangeDependencies() {
    precacheImage(
      const AssetImage('assets/images/02coffemaker/cow.png'),
      context,
    );
    precacheImage(
      const AssetImage('assets/images/02coffemaker/soy.png'),
      context,
    );
    precacheImage(
      const AssetImage('assets/images/02coffemaker/rice.png'),
      context,
    );
    precacheImage(
      const AssetImage('assets/images/02coffemaker/coconut.png'),
      context,
    );
          ...
          children: [
            Container(
              ...
              child: Transform.translate(
                offset: Offset(lerpDouble(-100, 0, animation.value)!, 0),
                child: Opacity(
